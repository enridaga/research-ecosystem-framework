...
@software{diamond_fonn_2022,
	...
	title = {% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{{{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}FONN} - {FOlk} {N}-gram {aNalysis}},
	shorttitle = {% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{{{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}FONN}},
