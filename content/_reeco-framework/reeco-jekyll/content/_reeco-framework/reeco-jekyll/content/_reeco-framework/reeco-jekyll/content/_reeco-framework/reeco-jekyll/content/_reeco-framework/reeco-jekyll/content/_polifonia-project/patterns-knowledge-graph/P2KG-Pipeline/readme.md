...
@software{patterns2Kg_jams_pipeline_2022,
	...
	title = {% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{{{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}P2KG} - {P}attern-2-{KG} {Knowledge Graph}},
	shorttitle = {% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{% raw %}{{{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}{% endraw %}P2KG}},
